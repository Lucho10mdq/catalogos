...
<br>
<form class="form-horizontal" method = "post" action = "<?php echo site_url('producto/modificarProductoSeleccionado');?>">
<fieldset>
...
<?php foreach ($producto as $pro) { ?>
  ...
  <div class="col-md-4">
  <input id="nombre" name="idProducto" type="text" placeholder="Nombre" class="form-control input-md" value ="<?php echo $pro['idProducto'];?>" >
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="nombre" name="nombre" type="text" placeholder="Nombre" class="form-control input-md" value ="<?php echo $pro['nombre'];?>" >
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input id="descripcion" name="descripcion" type="text" placeholder="Descripcion" class="form-control input-md" value = "<?php echo $pro['descripcion'];?>"> 
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="precio" name="precio" type="number" placeholder="Precio" class="form-control input-md" value = "<?php echo $pro["precio"];?>" >
